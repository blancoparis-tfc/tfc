...
public class TestJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
		...
		entityManager.setPackagesToScan(new String[] { "org.dbp.bom" });
		final JpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter();
		entityManager.setJpaVendorAdapter(vendorAdapter);
		entityManager.setJpaProperties(propiedadesAdicionalesJpa());
		...
		return new Properties() {
			{
				...
				setProperty("hibernate.hbm2ddl.import_files",
						"/META-INF/inicializar.sql,/META-INF/paises.sql,/META-INF/comunidades.sql,/META-INF/provincias.sql,/META-INF/municipios.sql");
			}
		};
	}
